            ...
            <div class="card-body">
              ...
              <form method="post" action="tambah-aksi.php">
                ...
                <div class="form-group">
                  <label>NIM</label>
                  <input type="text" name="nim" placeholder=" " class="form-control" required>
                </div>
                ...
                <div class="form-group">
                  <label>Prodi</label>
                  <input type="text" name="prodi" placeholder=" " class="form-control" required>
                </div>

                <div class="form-group">
                  <label>Kelas</label>
                  <input type="text" name="kelas" placeholder=" " class="form-control" required>
                </div>
