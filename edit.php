            ...
            $data = $conn->query("SELECT * FROM mahasiswa WHERE nim='$id'");
              ...
              <form method="post" action="update.php">
                ...
                <div class="form-group">
                  <label>NIM</label>
                  <input type="text" name="nim" placeholder=" " class="form-control" value="<?php echo $d['nim']; ?>" required>
                </div>
                ...
                <div class="form-group">
                  <label>Prodi</label>
                  <input type="text" name="prodi" placeholder=" " class="form-control" value="<?php echo $d['prodi']; ?>" required>
                </div>

                <div class="form-group">
                  <label>Kelas</label>
                  <input type="text" name="kelas" placeholder=" " class="form-control" value="<?php echo $d['kelas']; ?>" required>
                </div>
