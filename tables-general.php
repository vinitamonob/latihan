    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Mahasiwa</h5>
              <div class="col-sm-6">
                <a href="tambah.php" class="btn btn-success" >
                  <i class="bi-person"></i> <span>Tambah Mahasiswa</span></a>						
              </div>
              <br>
                ...
                <tbody>
                  ...
                  ?>
                    <tr>
                      ...
                      <td class=" "><?php echo $d['nim']; ?></td>
                      <td class=" "><?php echo $d['nama']; ?></td>
                      <td class=" "><?php echo $d['prodi']; ?></td>
                      <td class=" "><?php echo $d['kelas']; ?></td>
                      <td class=" "><?php echo $d['alamat']; ?></td>
                      <td class=" "><?php echo $d['telepon']; ?></td>
                      <td class="d-flex flex-row">
                        <a class="btn btn-sm btn-primary" href="edit.php?nim=<?php echo $d['nim']; ?>">Edit</a>
                        <a class="btn btn-sm btn-danger" href="hapus.php?nim=<?php echo $d['nim']; ?>">Hapus</a>
                      </td>
                    </tr>
                    <?php
                  }
